...
export const projects: Project[] = [
  ...
  {
    id: 'individual-1',
    title: 'Concept UNIQLO HTML Email',
    description: 'This project showcases my ability to create responsive and accessible HTML emails, focusing on modern design principles and best practices.',
    type: 'individual',
    image: UNIQLO,
